...
import { HomeworkTasksComponent } from "../../components/homework-tasks/index.js";
...
export class MainPage {
    ...
    getHTML() {
        return `
            <div id="main-page" class="container">
                ...
                <div class="homework-placeholder"></div>
            </div>
        `;
    }
    ...
    render() {
        ...
        const homeworkPlaceholder = document.querySelector('.homework-placeholder');
        const homeworkTasks = new HomeworkTasksComponent(homeworkPlaceholder);
        homeworkTasks.render();
    }
}