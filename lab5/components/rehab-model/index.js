export class RehabModelComponent {
    ...
    async initModel() {
        ...
        try {
            ...
            const onlineWheelchairUrl = 'https://github.com/microsoft/experimental-pcf-control-assets/raw/refs/heads/master/wheelchair.glb';
            const localWheelchairUrl = new URL('../../models/accessibility-wheelchair.glb', import.meta.url);

            const addWheelchairModel = (gltf) => {
